/*
  ...
  - You are about to drop the column `doctorId` on the `room_shifts` table. All the data in the column will be lost.
  - You are about to drop the column `endDate` on the `room_shifts` table. All the data in the column will be lost.
  - You are about to drop the column `startDate` on the `room_shifts` table. All the data in the column will be lost.
  - You are about to drop the column `weekdayMask` on the `room_shifts` table. All the data in the column will be lost.
...
-- DropForeignKey
ALTER TABLE "room_shifts" DROP CONSTRAINT "room_shifts_doctorId_fkey";

-- AlterTable
ALTER TABLE "room_shifts" DROP COLUMN "doctorId",
DROP COLUMN "endDate",
DROP COLUMN "startDate",
DROP COLUMN "weekdayMask";
